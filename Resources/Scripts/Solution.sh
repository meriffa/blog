...
dotnet new classlib --language "C#" --output ./Sources/ByteZoo.Blog.Profiler
...
dotnet sln ./Sources/ByteZoo.Blog.sln add ./Sources/ByteZoo.Blog.Profiler/ByteZoo.Blog.Profiler.csproj
