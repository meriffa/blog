...
public unsafe class ICorProfilerInfo12 : ICorProfilerInfo11, ICorProfilerInfoFactory<ICorProfilerInfo12>
{
    ...
    public HResult<EVENTPIPE_EVENT> EventPipeDefineEvent(EVENTPIPE_PROVIDER provider, string eventName, uint eventID, ulong keywords, uint eventVersion, uint level, byte opcode, bool needStack, ReadOnlySpan<COR_PRF_EVENTPIPE_PARAM_DESC> paramDescs)
    {
