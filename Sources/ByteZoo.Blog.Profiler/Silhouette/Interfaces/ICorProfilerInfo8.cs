...
internal unsafe interface ICorProfilerInfo8 : ICorProfilerInfo7
{
    ...
    */
    HResult GetFunctionFromIP3(nint ip, out FunctionId functionId, out ReJITId pReJitId);
    ...
    */
    HResult GetDynamicFunctionInfo(FunctionId functionId, out ModuleId moduleId, out nint pvSig, out uint pbSig, uint cchName, out uint pcchName, char* wszName);
