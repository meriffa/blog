...
internal unsafe interface ICorProfilerCallback4 : ICorProfilerCallback3
{
     ...
     */
    HResult ReJITCompilationStarted(FunctionId functionId, ReJITId rejitId, int fIsSafeToBlock);
     ...
     */
    HResult GetReJITParameters(ModuleId moduleId, MdMethodDef methodId, nint pFunctionControl);

    /*
     * Similar to JITCompilationFinished, except called when rejitting a method
     */
    HResult ReJITCompilationFinished(FunctionId functionId, ReJITId rejitId, HResult hrStatus, int fIsSafeToBlock);
     ...
     */
    HResult MovedReferences2(uint cMovedObjectIDRanges, ObjectId* oldObjectIDRangeStart, ObjectId* newObjectIDRangeStart, nint* cObjectIDRangeLength);
     ...
     */
    HResult SurvivingReferences2(uint cSurvivingObjectIDRanges, ObjectId* objectIDRangeStart, nint* cObjectIDRangeLength);
