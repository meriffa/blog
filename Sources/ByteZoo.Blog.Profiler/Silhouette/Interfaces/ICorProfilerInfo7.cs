...
internal unsafe interface ICorProfilerInfo7 : ICorProfilerInfo6
{
    ...
    */
    HResult ApplyMetaData(ModuleId moduleId);
    ...
    */
    HResult GetInMemorySymbolsLength(ModuleId moduleId, out uint countSymbolBytes);
    ...
    * CORPROF_E_MODULE_IS_DYNAMIC will be returned in that case.
    */
    HResult ReadInMemorySymbols(ModuleId moduleId, int symbolsReadOffset, byte* pSymbolBytes, uint countSymbolBytes, out uint pCountSymbolBytesRead);
