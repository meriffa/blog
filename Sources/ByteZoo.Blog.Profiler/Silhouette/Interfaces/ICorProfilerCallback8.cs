...
internal unsafe interface ICorProfilerCallback8 : ICorProfilerCallback7
{
    ...
    HResult DynamicMethodJITCompilationStarted(FunctionId functionId, int fIsSafeToBlock, byte* pILHeader, uint cbILHeader);

    HResult DynamicMethodJITCompilationFinished(FunctionId functionId, HResult hrStatus, int fIsSafeToBlock);
