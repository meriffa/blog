...
public enum COR_PRF_GC_ROOT_FLAGS
{
    ...
    COR_PRF_GC_ROOT_REFCOUNTED = 0x8  // Whether it prevents collection depends on a refcount - if not, COR_PRF_GC_ROOT_WEAKREF will be set also
}
...
public enum CorElementTypes : uint
{
    ...
    ELEMENT_TYPE_SZARRAY = 0x1d,     // Shortcut for single dimension zero lower bound array SZARRAY <type>
