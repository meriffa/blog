...
Assembly_Function1:     push                    rbp                                             ; long AssemblyFunction1([MarshalAs(UnmanagedType.U1)] bool p1, byte p2, sbyte p3, [MarshalAs(UnmanagedType.U2)] char p4, short p5, ushort p6, int p7, uint p8, long p9, ulong p10);
                        mov                     rbp, rsp
                        xor                     rax, rax
                        add                     al, dil                                         ; p1
                        add                     al, sil                                         ; p2
...
Assembly_Function2:     push                    rbp                                             ; double AssemblyFunction2(float p1, double p2, float p3, double p4, float p5, double p6, float p7, double p8, float p9, double p10);
                        mov                     rbp, rsp
...
Assembly_Function4:     push                    rbp                                             ; Structure4 AssemblyFunction4(Structure1 p1, Structure2 p2, ref Structure1 p3, out Structure1 p4, [MarshalUsing(typeof(DecimalMarshaller))] ref decimal p5, string p6, in int[] p7, int p8);
                        mov                     rbp, rsp
                        xor                     r10, r10
                        mov                     rax, rsi                                        ; p1
                        shl                     rax, 32
